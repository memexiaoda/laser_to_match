...
/**
  ...
  public:
     ...
     */
    bool InverseFast(Matrix3& rkInverse, double fTolerance = TOLERANCE) const
    {
  ...
  public:
     ...
     * @return mat(r,c)
     */
    inline double operator()(unsigned int row, unsigned int column) const
    {
      return m_Matrix[row][column];
    }
  ...
  private:
     ...
     * @param column
     */
    inline void RangeCheck(unsigned int row, unsigned int column) const
    {
